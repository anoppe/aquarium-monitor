...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bower: {
    	target: {
    		rjsConfig: '<%= yeoman.app %>/config.js',
    	}
    },
    ...
    bowerInstall: {
      app: {
        ...
        exclude: ['!<%= yeoman.app %>/bower_components/requirejs/require.js'],
      }
    },
...
//    	      name: 'scripts/config', // assumes a production build using almond
    	      dir: '<%= yeoman.dist %>',
//    	      out: '<%= yeoman.dist %>/scripts/config.js',
//    	      onBuildWrite: function (moduleName, path, contents) {
//    	          //Always return a value.
//    	          //This is just a contrived example.
//    	          return contents.replace(/bower_components/g, './vendor');
//    	      },
